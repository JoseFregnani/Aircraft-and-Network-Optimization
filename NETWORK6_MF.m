...
%
% VERSION: 6.0 / December 2018 - Network optimiztion with 3 aircraft + NPV
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[~,~,DOC1]=Mission5g(0,0,0,0,0,RANGE1,200,3000,2500,2500,15,15,15,ISADEV,PAYLOAD1,ACFT1,10,0); 
[~,~,DOC2]=Mission5g(0,0,0,0,0,RANGE2,200,3000,2500,2500,15,15,15,ISADEV,PAYLOAD2,ACFT2,10,0);
[~,~,DOC3]=Mission5g(0,0,0,0,0,RANGE3,200,3000,2500,2500,15,15,15,ISADEV,PAYLOAD2,ACFT3,10,0);
        ...
        for j=1:n
           if i~=j;
               if X(i,j,a)~=0;
                 ...
                 [Wf(i,j,a),T(i,j,a),CF(i,j,a)]=Mission5g(Origelev,Destelev,Altelev,TH,THA,DISTANCE,DISTALT,ASDA,LDA,ALT_LDA,DEP_TREF,ARR_TREF,ALT_TREF,ISADEV,PAYLOAD,ACFT,TAXITIME,1);  
