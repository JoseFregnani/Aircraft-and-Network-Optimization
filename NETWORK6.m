...
% NETWORK RESULTS  
    ...
    TOTFUEL(a)=TOTFUEL(a)/1E3;
    %
    fprintf('\n');
    fprintf('\n ** NETWORK RESULTS **');
    fprintf('\n'); 
    fprintf('\n Average Cruise Mach      : %10.3f',AVGMACH(a));
    fprintf('\n TOTAL FUEL (ton)         : %10.2f',TOTFUEL(a));
    fprintf('\n TOTAL CO2  (ton)         : %10.2f',TOTFUEL(a)*3.15);
